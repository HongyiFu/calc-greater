...
ActiveRecord::Schema.define(version: 20170531104829) do
  ...
  create_table "portfolio_stocks", force: :cascade do |t|
    ...
    t.datetime "created_at",   null: false
    t.datetime "updated_at",   null: false
    t.index ["portfolio_id"], name: "index_portfolio_stocks_on_portfolio_id", using: :btree
    t.index ["stock_id"], name: "index_portfolio_stocks_on_stock_id", using: :btree
  end
